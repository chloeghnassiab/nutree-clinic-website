  ...
  return (
    <>
      ...
      <section style={{ padding: '2.5rem 1rem 1.5rem', background: 'linear-gradient(145deg, var(--con) 0%, #FAD8CC 55%, #FFF0EC 100%)' }}>
        <div style={{ fontSize: '0.5625rem', fontWeight: 700, color: 'var(--con-dark)', textTransform: 'uppercase', letterSpacing: '0.14em', marginBottom: '0.875rem' }}>
        ...
        <p style={{ fontSize: '0.8125rem', color: 'var(--ink-2)', lineHeight: 1.7, marginBottom: '1.25rem', maxWidth: 300 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.75rem', marginBottom: '1rem' }}>
          ...
          <div style={{ fontSize: '0.75rem', color: 'var(--ink-2)', lineHeight: 1.4 }}>30-minute consultation<br />with a licensed provider</div>
        </div>
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: 'rgba(82,159,153,0.12)', border: '1px solid rgba(82,159,153,0.25)', borderRadius: 'var(--radius-pill)', padding: '6px 14px', fontSize: '0.75rem', fontWeight: 600, color: 'var(--teal)', marginBottom: '1.25rem' }}>
      ...
      <section style={{ padding: '1.5rem 1rem', background: 'var(--white)', borderTop: '1px solid var(--border)' }}>
        <div style={{ fontSize: '0.5625rem', fontWeight: 700, color: 'var(--con-dark)', textTransform: 'uppercase', letterSpacing: '0.14em', marginBottom: '0.875rem' }}>What&apos;s included</div>
          ...
          {[
            ...
            <div key={i} style={{ display: 'flex', gap: '0.75rem', padding: '0.875rem', borderRadius: 'var(--radius-md)', background: 'var(--base)', border: '0.5px solid var(--border)' }}>
              ...
              <div>
                ...
                <div style={{ fontSize: '0.625rem', color: 'var(--ink-3)', lineHeight: 1.55 }}>{item.desc}</div>
              </div>
            </div>
          ))}
        </div>
      ...
      <section style={{ padding: '1.5rem 1rem', background: 'var(--base)', borderTop: '1px solid var(--border)' }}>
        <div style={{ fontSize: '0.5625rem', fontWeight: 700, color: 'var(--con-dark)', textTransform: 'uppercase', letterSpacing: '0.14em', marginBottom: '0.5rem' }}>Who books a consultation?</div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.375rem' }}>
          {[
            ...
            <div key={i} style={{ display: 'flex', gap: '0.75rem', padding: '0.75rem', borderRadius: 'var(--radius-md)', background: 'var(--white)', border: '0.5px solid var(--border)' }}>
              ...
              <div>
                <div style={{ fontSize: '0.6875rem', fontWeight: 700, color: 'var(--ink)', marginBottom: 2 }}>{item.t}</div>
                <div style={{ fontSize: '0.5625rem', color: 'var(--ink-3)', lineHeight: 1.55 }}>{item.d}</div>
              </div>
            </div>
          ))}
        </div>
      ...
      <section style={{ padding: '1.25rem 1rem', background: 'var(--white)', borderTop: '1px solid var(--border)' }}>
        <div style={{ background: 'var(--base)', borderRadius: 'var(--radius-lg)', padding: '1rem', border: '0.5px solid var(--border)' }}>
          <div style={{ fontSize: '0.5625rem', fontWeight: 700, color: 'var(--ink-3)', textTransform: 'uppercase', letterSpacing: '0.14em', marginBottom: '0.375rem' }}>Our approach</div>
      ...
      <section style={{ background: 'var(--ink)', padding: '1.5rem 1rem', textAlign: 'center' }}>
        ...
        <div style={{ fontSize: '0.625rem', color: 'rgba(255,255,255,0.5)', marginBottom: '1rem' }}>No pressure to commit to anything on the call</div>
