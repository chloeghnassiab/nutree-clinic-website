  ...
  return (
    <>
      ...
      <section style={{ padding: '2.5rem 1rem 1.5rem', background: 'var(--base)' }}>
        <div style={{ fontSize: '0.5625rem', fontWeight: 700, color: 'var(--teal)', textTransform: 'uppercase', letterSpacing: '0.14em', marginBottom: '0.875rem' }}>Our story</div>
        ...
        <p style={{ fontSize: '0.8125rem', color: 'var(--ink-2)', lineHeight: 1.75, marginBottom: '0.875rem', maxWidth: 560 }}>
        ...
        <p style={{ fontSize: '0.8125rem', color: 'var(--ink-2)', lineHeight: 1.75, maxWidth: 560 }}>
      ...
      <section style={{ padding: '1.5rem 1rem', background: 'var(--white)', borderTop: '1px solid var(--border)' }}>
        <div style={{ fontSize: '0.5625rem', fontWeight: 700, color: 'var(--ink-3)', textTransform: 'uppercase', letterSpacing: '0.14em', marginBottom: '0.875rem' }}>Our team</div>
        ...
        <div style={{ display: 'flex', gap: '1rem', marginBottom: '1.25rem', alignItems: 'flex-start' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '0.625rem', fontWeight: 600, color: 'var(--teal)', marginBottom: '0.5rem', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Founder · Managing Member</div>
            <p style={{ fontSize: '0.6875rem', color: 'var(--ink-3)', lineHeight: 1.65 }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '0.625rem', fontWeight: 600, color: 'var(--teal)', marginBottom: '0.5rem', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Medical Director</div>
            <p style={{ fontSize: '0.6875rem', color: 'var(--ink-3)', lineHeight: 1.65 }}>
      ...
      <section style={{ padding: '1.5rem 1rem', background: 'var(--base)', borderTop: '1px solid var(--border)' }}>
        <div style={{ fontSize: '0.5625rem', fontWeight: 700, color: 'var(--ink-3)', textTransform: 'uppercase', letterSpacing: '0.14em', marginBottom: '0.875rem' }}>What we believe</div>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          {[
            ...
            <div key={i} style={{ background: 'var(--white)', borderRadius: 'var(--radius-md)', padding: '0.875rem', border: '0.5px solid var(--border)' }}>
              <div style={{ fontSize: '0.75rem', fontWeight: 700, color: 'var(--ink)', marginBottom: 4 }}>{v.title}</div>
              <div style={{ fontSize: '0.625rem', color: 'var(--ink-3)', lineHeight: 1.65 }}>{v.body}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section style={{ padding: '1.25rem 1rem', background: 'var(--white)', borderTop: '1px solid var(--border)' }}>
        <div style={{ fontSize: '0.5625rem', fontWeight: 700, color: 'var(--ink-3)', textTransform: 'uppercase', letterSpacing: '0.14em', marginBottom: '0.75rem' }}>Credentials & compliance</div>
      ...
      <section style={{ background: 'var(--ink)', padding: '1.5rem 1rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '1rem' }}>
        <div>
          ...
          <div style={{ fontSize: '0.5625rem', color: 'rgba(255,255,255,0.45)' }}>30 min · licensed clinician · video or phone</div>
        </div>
