...
const HOW_STEPS = [
  { n: '1', title: 'Complete a brief health questionnaire', desc: 'Takes 3 minutes. Your clinician reviews your history and goals before the consultation.', color: '#B8E4F0' },
  { n: '2', title: 'Meet with a licensed Nutree clinician', desc: 'A real clinical conversation — your provider determines what is medically appropriate for you, or none if it isn\'t right.', color: '#A8D8C8' },
  ...
  { n: '4', title: 'Ongoing care and check-ins', desc: 'Your provider monitors your progress and adjusts your plan throughout.', color: '#D4B8E8' },
]
    ...
    <>
      ...
      <section style={{ padding: '2rem 1.5rem', background: 'var(--white)', borderTop: '1px solid var(--border)' }}>
        ...
        <div style={{ background: 'var(--base)', borderRadius: 16, padding: '1.5rem', border: '0.5px solid var(--border)' }}>
          ...
          <div style={{ display: 'inline-block', marginTop: 8, fontSize: '0.875rem', fontWeight: 700, padding: '4px 12px', borderRadius: 999, background: '#B8E4F0', color: '#1A6B85' }}>GLP-1 Microdosing</div>
        </div>
      </section>
